...
module ModuleParseCS
    ...
    integer,        parameter                   :: nGibbsCoeff = 15, nMaxGibbsEqs = 6, nParamMax = 4
    ...
    character(30),  dimension(:),   allocatable, target :: cSolnPhaseNameCS
    character(30),  dimension(:),   allocatable, target :: cSpeciesNameCS
